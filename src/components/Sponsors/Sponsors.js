  ...
  return (
    ...
    <div class="container-grid-1-item">      
      <div class="spons-container w-6 h-1">
        <div class="spons-item">
          <img src={require("../../assets/pepsicoLogo.png")} alt="" className="pepsico-image" />
        </div>
      </div>
    </div> 
    <div className="text-spons">
    ...
    <div class="container-grid-spons">  
        <div class="spons-container w-1 h-1">
          <div class="sponsspons-item">
            <img src={require("../../assets/ongcLogo.jpg")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="sponsspons-item">
            <img src={require("../../assets/dukesLogo.png")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/samsung.png")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
      ...
      <div class="container-grid-spons">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/jainIrrigation.png")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/anushaProjects.png")} alt="" class="logo-image" />
          </div>
        </div>
      </div>
      <div class="container-grid-2_items">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/signetGroup.png")} alt="" class="logo-image" />
          </div>
        </div>
      </div>
      <div className="text-spons">
      ...
      <div class="container-grid-spons">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/ITCLogo.png")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/mahindraEPGLogo.jpg")} alt="" class="logo-image" />
          </div>
        </div>
      </div>
      <div class="container-grid-spons">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/NTPCLogo.png")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
      ...
      <div class="container-grid-spons">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/elitebiotechLogo.png")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
      ...
      <div class="container-grid-spons">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/museeMusicalLogo.jpg")} alt="" class="logo-image" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/GMSolarLogo.png")} alt="" class="logo-image" />
          </div>
        </div>
      </div>
      <div class="container-grid-spons">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/adda52logo.jpeg")} alt="" class="adda-logo" />
          </div>
        </div>
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/greenSoleLogo.jpg")} alt="" class="logo-image" />
          </div>
        </div>
      </div>
      <div class="container-grid-2_items">
        ...
        <div class="spons-container w-1 h-1">
          <div class="spons-item">
            <img src={require("../../assets/stucredLogo.png")} alt="" class="logo-image" />
          </div>
        </div>
      </div>
    </div>
